module.exports = {
  ...
  siteUrl: "http://alchemyguy.in", // Domain of your website without pathPrefix.
  pathPrefix: "/", // Prefixes all links. For cases when deployed to example.github.io/gatsby-starter-casper/.
  siteDescription:
    "A blogsite for sharing life experiences with travel, music and software development", // Website description used for RSS feeds/meta description tag.
  siteCover: "/images/blog-cover.jpg", //"https://alchemyguy.in/images/blog-cover.jpg", // Optional, the cover image used in header for home page. e.g:
  ...
  userLinks: [
    {
      label: "GitHub",
      url: "https://github.com/alchemyguy",
      iconClassName: "fa fa-github" // Disabled, see Navigation.jsx
    },
    {
      label: "Twitter",
      url: "https://twitter.com/Alchemy_Guy",
    ...
    {
      label: "Medium",
      url: "https://medium.com/@alchemyguy",
      iconClassName: "fa fa-medium" // Disabled, see Navigation.jsx
    }
  ],
  // Copyright string for the footer of the website and RSS feed.
  copyright: {
    label: "Mukesh Chandra" // Label used before the year
